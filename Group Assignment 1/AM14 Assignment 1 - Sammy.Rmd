...
```{r}
#creating matrix for holding period returns
...
#creating matrix for log returns
...
#mutate log returns for S&P 500
HPR_daily <- HPR_daily %>% 
...
#create the log return squared matrix
...
Comments: xxxxxxxxxxxxx to be added 
