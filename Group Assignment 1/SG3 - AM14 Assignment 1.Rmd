...
```{r plotting_monthly_total_return_index_MSFT, fig.height=7, fig.width=12}
...
```{r plotting_monthly_total_return_index_GE, fig.height=7, fig.width=12}
...
```{r normalizing_monthly_GE_price, fig.height=7, fig.width=12}
...
```{r MSFT_monthly_returns_plot, fig.height=7, fig.width=12}
...
```{r logged_returns_comparison, warning=FALSE, fig.height=10, fig.width=20}
...
```{r MSFT_log_returns_distribution, fig.height=10, fig.width=12}
...
### For MSFT
```{r MSFT_ACF, fig.height=5, fig.width=5}
...
### For GE
```{r GE_ACF, fig.height=5, fig.width=5}
...
```{r JPM_ACF, fig.height=5, fig.width=5}
...
```{r plotting_portfolio_returns, fig.height=7, fig.width=15}
...
```{r return_unequal_weight_PTFOLIO}
...
```{r plotting_the_frontier, fig.height=10, fig.width=10}
